...
public class DB {
	...
	// Establish connection with the database, initialize and return Connection object.
	public Connection getConnection() throws Exception {
		...
		// Step 2 -> Establish a connection with the database and initializes Connection object (con)
		try {
	...
	// Close database connection. It is very important to close the database connection after it is used.
